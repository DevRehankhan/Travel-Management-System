...
?>
	...
	<head>
		<title>T&TMS | Admin Dashboard</title>
						...
						<div class="col-md-3 four-grid">
							<div class="four-agileinfo">
								...
								<div class="four-text">
									...
									<?php $sql1 = "SELECT BookingId from tbltravelbooking";
									$query1 = $dbh->prepare($sql1);
									$query1->execute();
									$results1 = $query1->fetchAll(PDO::FETCH_OBJ);
									$cnt1 = $query1->rowCount();
					...
					<div class="four-grids">
						...
						<div class="col-md-3 four-grid">
							<div class="four-wthree">
								...
								<div class="four-text">
									<h3>Toatal Travels</h3>
									<?php $sql3 = "SELECT TravelId from tbltravel";
									$query3 = $dbh->prepare($sql3);
									$query3->execute();
									$results3 = $query3->fetchAll(PDO::FETCH_OBJ);
									$cnt3 = $query3->rowCount();
						...
						<div class="col-md-3 four-grid">
							<div class="four-wthree">
								...
								<div class="four-text">
									<h3>Toatal Hotels</h3>
									<?php $sql3 = "SELECT HotelId from tblhotel";
									$query3 = $dbh->prepare($sql3);
									$query3->execute();
									$results3 = $query3->fetchAll(PDO::FETCH_OBJ);
									$cnt3 = $query3->rowCount();
